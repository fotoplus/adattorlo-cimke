        ...
        <form method="post" action="/feltoltes/cimke" autocomplete="off">
          <fieldset>
              ...
              <select name="iktatoszam" required>
                <option <?php if(!$cimke['iktatoszam']) { print('selected="selected"'); } ?> disabled="disabled">Válassz a listából</option>
                <?php
                  ...
                  while($iktatoszamok = $result_iktatoszamok->fetch_assoc()) {
                    ...
                    if($cimke['iktatoszam']==$iktatoszamok['id']) { print('selected="selected"'); }
